        ...
        <div className="p-4 mx-4 my-4 bg-emerald-50/90 border border-emerald-200/80 rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="font-bold text-xs text-gray-900 truncate">{moderator.name || 'Staff Moderator'}</div>
              <div className="text-[11px] text-brand-green font-extrabold truncate">Platform Moderator</div>
            </div>
          </div>
        </div>
        ...
        <header className="h-16 md:h-20 bg-white/80 backdrop-blur-xl border-b border-white/80 flex items-center justify-between px-4 md:px-8 z-20 shrink-0 shadow-[0_4px_30px_rgba(0,0,0,0.02)] sticky top-0">
          ...
          <div className="hidden md:flex items-center gap-3">
            <h2 className="text-base lg:text-lg font-extrabold text-gray-800 tracking-tight">
              Swamy Dwija Foundation • Moderator Workspace
            </h2>
          </div>
          ...
          <div className="flex items-center gap-2.5 sm:gap-4">
            ...
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-[#0A4F2A] to-[#15803d] text-white flex items-center justify-center font-black text-xs shadow-md">
                {moderator.name ? moderator.name.charAt(0).toUpperCase() : 'M'}
              </div>
              <div className="hidden sm:flex flex-col">
                <span className="text-xs font-bold text-gray-900 leading-tight truncate max-w-[120px]">{moderator.name || 'Moderator'}</span>
            ...
            >
              ...
              <div className="p-4 bg-emerald-50/80 border border-emerald-200/80 rounded-2xl mb-5 space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-extrabold text-sm text-gray-900 truncate">{moderator.name || 'Moderator'}</div>
                    <div className="text-xs text-brand-green font-bold truncate">Platform Oversight</div>
                  </div>
                </div>

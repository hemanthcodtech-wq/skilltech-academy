...
const TopNav = () => {
  ...
  return (
    <header
      className="fixed top-0 left-0 w-full z-50 flex items-center px-4 md:px-8 xl:px-24 h-18 md:h-20 bg-white/80 backdrop-blur-md border-b border-white/40 shadow-[0_4px_20px_rgba(0,0,0,0.03)]"
    >
      ...
      {/* Desktop Nav Links */}
      <nav className="hidden md:flex items-center gap-8 ml-8 lg:ml-12">
        {navItems.map((item) => (
          <NavLink
            key={item.name}
            to={item.path}
            ...
            className={({ isActive }) =>
              `relative font-medium text-[15px] transition-colors hover:text-indigo-600 ${
              ...
              <>
                ...
                {isActive && (
                  <motion.div
                    ...
                    className="absolute -bottom-7 left-0 w-full h-1 bg-indigo-600 rounded-t-md"
      ...
      <div className="flex items-center gap-2 md:gap-4 relative z-10 ml-auto">
        ...
        <div className="flex items-center gap-1 px-2 py-1.5 md:px-3 md:py-2 rounded-full border border-gray-200 bg-white hover:bg-gray-50 transition-colors shadow-sm">
          <FaGlobe className="text-indigo-600 text-[10px] md:text-xs" />
          <select
            value={lang}
        ...
        <button className="relative p-2 text-gray-500 hover:text-indigo-600 transition-colors bg-white rounded-full shadow-sm">
          <FaBell size={18} />
        ...
        <NavLink to="/dashboard/profile" className="hidden md:flex items-center gap-2 pl-2 md:pl-4 border-l border-gray-200">
          <div className="w-10 h-10 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600 overflow-hidden">
            <FaUser size={16} />
          </div>
